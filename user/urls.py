...
from .views import ResendOTPView, LoginView, RegisterView, VerifyOTPView,PasswordResetRequestView, GoogleSignupAPIView,PasswordResetConfirmView,SubmitNewPasswordView, PasswordResetStatusView , SendCuteEmail , GoogleLoginAPIView
